...
/*   Updated: 2025/05/17 19:32:01 by mhamdali         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	are_all_philosophers_satisfied(t_data *data, int full_philosophers)
{
...
int	monitor_philosophers(t_data *data)
{
	...
	return (are_all_philosophers_satisfied(data, full_philosophers));
}
